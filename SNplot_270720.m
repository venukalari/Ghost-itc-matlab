function  SNplot_270720(lambda1,lambda2,AB_low,AB_high,t_exp,ZD,resoln,seeing,N_mirror,SR_sky,bin_spat,N_sub)
...
%
    col1 = colours(10,:);  % the strong one
    col2 = colours(15,:); % the lighter one
...
%
    for i = 1:n_AB
        ...
        [SN1(i), vars1(:,i)]=SNmain(lambda1,AB(i),t_exp,ZD,resoln,seeing,N_mirror,SR_sky,bin_spat,N_sub,0);
        [SN2(i), vars2(:,i)]=SNmain(lambda2,AB(i),t_exp,ZD,resoln,seeing,N_mirror,SR_sky,bin_spat,N_sub,0);
    end
%
    X = [AB AB(end:-1:1)];
    Y = [SN1 SN2(end:-1:1)];
